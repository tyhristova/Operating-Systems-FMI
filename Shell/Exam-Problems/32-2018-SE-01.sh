...
# find typove 
# awk obsht broi redove za vsqko
# sort -k (redove) | head -n 10
...
find "${LOGDIR}" -type f -regextype posix-extended -regex '.*/[0-9]{4}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}\.txt$' -print0
